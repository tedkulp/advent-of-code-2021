...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var dataList, answerAList, rollingSumList, answerBList;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fs_1.promises.readFile("./data.txt")];
            case 1:
                dataList = (_a.sent())
                    .toString()
                    .split("\n")
                    .map(function (line) { return parseInt(line); });
                answerAList = dataList
                    .map(function (i, idx) {
                    if (idx > 0) {
                ...
                answerBList = rollingSumList
                    ...
                    .filter(function (i) { return i; });
                console.log("#1 Answer", answerBList.length);
                return [2 /*return*/];
        }
    });
}); })();
